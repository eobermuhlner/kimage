...
public class FileDirectory {
	...
	public FileDirectory(SortedSet<FileDirectoryEntry> entries,
		...
		tiled = false; // TODO HACK to parse TIF of DeepSkyStacker
	...
	public Number getTileWidth() {
		return tiled && getNumberEntryValue(FieldTagType.TileWidth) != null ? getNumberEntryValue(FieldTagType.TileWidth)
				: getImageWidth();
	}
	...
	public Number getTileHeight() {
		Number tileHeight = null;

		if (tiled) {
			tileHeight = getNumberEntryValue(FieldTagType.TileLength);
		}
		if (tileHeight == null) {
			tileHeight = getRowsPerStrip();
		}
		if (tileHeight == null) {
			tileHeight = getImageHeight();
		}
		return tileHeight;
	}
	 ...
	 * @since 2.0.0
	 */
	public void setUnsignedIntegerEntryValue(
	 ...
	 * @since 2.0.0
	 */
	public void setUnsignedLongEntryValue(
      FieldTagType fieldTagType,
			long value) {
	 ...
	 * @since 2.0.0
	 */
	public void setUnsignedIntegerListEntryValue(
      FieldTagType fieldTagType,
			List<Integer> value) {
	 ...
	 * @since 2.0.0
	 */
	public void setUnsignedLongListEntryValue(
      FieldTagType fieldTagType,
			List<Long> value) {
	 ...
	 * @since 2.0.1
	 */
	public void setRationalEntryValue(
      FieldTagType fieldTagType,
			List<Long> value) {
	...
	private void setEntryValue(
      FieldTagType fieldTagType, FieldType fieldType,
