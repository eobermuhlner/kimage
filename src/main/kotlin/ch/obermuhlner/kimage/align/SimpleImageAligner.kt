...
class SimpleImageAligner(val radiusX1: Int = 50, val radiusY1: Int = 0, val radiusX2: Int = 100, val radiusY2: Int = 100, val errorThreshold: Double = 1.01, val channel: Channel = Channel.Red) :
    ImageAligner {
