...
object AwtImageUtil {
    ...
    fun graphics(image: Image, marginTop: Int, marginLeft: Int, marginBottom: Int, marginRight: Int, func: (java.awt.Graphics2D, Int, Int) -> Unit): Image {
        ...
        graphics.drawImage(bufferedImage, marginTop, marginLeft, null)

        func(graphics, width, height)
