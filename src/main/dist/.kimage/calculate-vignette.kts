...
kimage(0.1) {
    name = "calculate-vignette"
    title = "Calculate a model for the vignette effect from image"
    description = """
                Calculates a statistical model of the vignette effect of the input image.
                """
    arguments {
        optionalInt("centerX") {
            description = """
